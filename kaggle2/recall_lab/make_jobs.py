...
VARIANTS = [
    {"name": "r0_base", "cap": 5000, "key_cap": 200, "caps": {}, "keep_prk": 60},
    {"name": "r1_aux_x2", "cap": 5000, "key_cap": 200, "caps": {"3": 30, "4": 30, "5": 40, "6": 25}, "keep_prk": 60},
    {"name": "r2_df20k", "cap": 20000, "key_cap": 400, "caps": {}, "keep_prk": 60},
    {"name": "r3_df2k", "cap": 2000, "key_cap": 200, "caps": {}, "keep_prk": 60},
    {"name": "r4_prk100_tri25", "cap": 5000, "key_cap": 200, "caps": {"6": 25}, "keep_prk": 100},
]
for v in VARIANTS:
    ...
    json.dump({"id": f"satvik006/{slug}", "title": slug, "code_file": "run_recall_lab.py", "language": "python", "kernel_type": "script",
               ...
               "dataset_sources": ["satvik006/er-bundle"], "competition_sources": [], "kernel_sources": []}, open(f"{d}/kernel-metadata.json", "w"), indent=1)
    print(d, slug)
