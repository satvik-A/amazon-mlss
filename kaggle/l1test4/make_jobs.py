"""One level-1 test job per country (pass 4): kaggle/l1test3/jobs/<country>/. Usage: python make_jobs.py <git ref>"""
import json, os, sys
...
for c in ("US", "India", "France"):
    ...
    json.dump({"id": f"satvikaderla/{slug}", "title": slug, "code_file": "run_submit.py", "language": "python", "kernel_type": "script",
               ...
               "kernel_sources": ["satvikaderla/er-artifacts", f"satvikaderla/er-cands4-test-{c.lower()}", "satvikaderla/er-matcher-full4"]},
