...
if __name__ == "__main__":
    for t in ["राम मार्केटिंग प्राइवेट लिमिटेड", "సాయి ఇండో హాస్పిటాలిటీ ప్రైవేట్ లిమిటెడ్", "લાઇફ ફૂડ્સ પ્રા. લિ.",
              "सिल्वर एस्टेट प्राइवेट लिमिटेड", "महाराष्ट्र", "ಕರ್ನಾಟಕ", "தமிழ்நாடு", "ଓଡ଼ିଶା"]:
        print(t, "->", translit(t))
